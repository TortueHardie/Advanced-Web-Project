...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer toutes les commandes (admin/restaurant)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Liste de toutes les commandes' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Non autorisé' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Détails de la commande' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Non autorisé' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Commande annulée avec succès' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Non autorisé' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Commande non trouvée' }),
    __param(0, (0, common_1.Headers)('authorization')),
    __param(1, (0, common_1.Param)('orderId')),
